                    ...
                    <table className="w-full min-w-[640px] table-auto border border-gray-200">
                        <thead>
                            <tr className="bg-gray-100">
                                {["Nom", "Prénom", "Lieu (Nouveau)", "Date (Nouveau)", "Lieu (Ancien)", "Date (Ancien)", "Similarité", "Actions"].map((header) => (
                        ...
                        <tbody>
                            {frauds.map((item, index) => (
                                <tr key={index} className="text-center text-sm">
                                    ...
                                    <td className="px-4 py-2 border-b">{item.ancienConstat?.location}</td>
                                    <td className="px-4 py-2 border-b">{new Date(item.ancienConstat?.date).toLocaleDateString()}</td>
