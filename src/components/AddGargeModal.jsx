...
export default function AddGargeModal({ open, handleClose, onGargeAdded }) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            setLoading(true);
            const res = await apiClient.post("/admin/AjouterGrage", form); 
    ...
    return (
        <Dialog open={open} handler={() => {
            ...
            <DialogHeader>Ajouter un garage</DialogHeader>
